...
def decon(method, seg_file, argAlpha, argBeta):
    ...
    for l in seg_file:
        ...
        if method == 'copy':
            ...
            R = [zero, 1/2.0, 2/2.0, 2/2.0, 3/2.0, 3/2.0, 4/2.0, 4/2.0, 4/2.0, 5/2.0, 5/2.0, 5/2.0, 6/2.0, 6/2.0, 6/2.0, 6/2.0]
            ...
            S = [1/2.0, zeroA, zeroA, zeroA, zeroA, 1/3.0, zeroA, 1/4.0, 2/4.0, zeroA, 1/5.0, 2/5.0, zeroA, 1/6.0, 2/6.0, 3/6.0]

            # just for the output string, to convert y_best to number of copies
            # copy_count = [1,2,3,4,4,5,5] # max chroms: 5
            # copy_count = [1,2,3,4,4,5,5,6,6,6]
            copy_count = [0,1,2,2,3,3,4,4,4,5,5,5,6,6,6,6]
